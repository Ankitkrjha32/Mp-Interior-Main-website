        ...
        <div className='lg:w-[40%]'>
            <div className='flex flex-col gap-6 rounded-xl bg- p-4 lg:p-6'>
                <div className='flex flex-col gap-[2px] p-3 text-sm text-richblack-200'>
                    ...
                    <h1 className="text-lg  text-richblack-5 font-bold">Chat on us</h1>
                    </div>
                    <p className='font-semibold' >Our friendly team is here to help.</p>
                    <p className='font-semibold'>mpinterious@gmail.com</p>
                </div>
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
                    ...
                    <p className='font-semibold capitalize'>jhilam apartment 3rd road east  kodalia , new barrackpore kolkata 700131 </p>
                </div>
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
                ...
                <p className='font-semibold'>+91 8961340538</p>
                </div>
            </div>
        </div>
