...
const ContactUsForm = () => {
  ...
  return (
    ...
    <div >
        <form onSubmit={handleSubmit(onSubmit)} className={"flex flex-col gap-7 text-white"}>

        <div className="flex flex-col gap-5 lg:flex-row"><div className="flex flex-col gap-2 lg:w-[48%]"><label htmlFor="firstname" className="">First Name</label><input type="text" name="firstname" id="firstname" placeholder="Enter first name"
